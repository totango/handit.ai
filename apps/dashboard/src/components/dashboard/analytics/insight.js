 ...
 * 
 * Displays key insights and metrics in a card format, showing important
 * analytics data with trend indicators and percentage changes.
 */
 ...
 * @param {Object} props.data - Analytics data for insights
 * @param {string} props.data.title - Title of the insight
 * @param {number} props.data.value - Current value
 * @param {number} props.data.change - Percentage change
 * @param {boolean} props.data.positive - Whether the change is positive
 * @returns {JSX.Element} The insight analytics component
 */
