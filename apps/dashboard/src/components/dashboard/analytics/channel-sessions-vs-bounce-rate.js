/**
 * Channel Sessions vs Bounce Rate Analytics Component
 * 
 * Displays a comparison of channel-specific analytics, showing:
 * - Session counts by channel
 * - Bounce rates for each channel
 * - Trend analysis over time
 * Includes bar chart visualization and percentage breakdowns.
 */
...
/**
 * ChannelSessionsVsBounceRate Component
 * 
 * @param {Object} props - Component props
 * @param {Object} props.data - Analytics data for channel comparison
 * @param {Array<Object>} props.data.series - Channel-specific metrics
 * @param {string} props.data.series[].name - Channel name
 ...
 * @returns {JSX.Element} The channel sessions vs bounce rate component
 */
export function ChannelSessionsVsBounceRate({ data }) {
