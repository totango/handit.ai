/**
 * Inbound/Outbound Analytics Component
 * 
 * Displays analytics comparing inbound and outbound traffic metrics.
 * Shows trends over time with a line chart visualization and includes
 * key metrics like total sessions and bounce rates.
 */
...
/**
 * InboundOutbound Component
 * 
 * @param {Object} props - Component props
 * @param {Object} props.data - Analytics data for inbound/outbound traffic
 * @param {Array<Object>} props.data.series - Time series data for traffic metrics
 * @param {string} props.data.series[].name - Name of the metric
 * @param {Array<number>} props.data.series[].data - Array of values over time
 * @param {Array<string>} props.data.categories - Time categories for x-axis
 * @returns {JSX.Element} The inbound/outbound analytics component
 */
