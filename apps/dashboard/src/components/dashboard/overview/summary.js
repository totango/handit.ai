      ...
      <Box sx={{ p: '16px' }}>
        <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
          <Box
            sx={{
              alignItems: 'center',
              color: trend === 'up' ?  'var(--mui-palette-error-main)' : 'var(--mui-palette-success-main)',
              display: 'flex',
          ...
          <Typography color="text.secondary" variant="body2">
            <Typography color={trend === 'up' ? 'error.main' : 'success.main'} component="span" variant="subtitle2">
              {Math.abs(diff)}
            </Typography>{' '}
