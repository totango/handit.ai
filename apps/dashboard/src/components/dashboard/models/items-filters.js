/**
 * @fileoverview ItemsFilters component for model filtering and view controls
 * Provides search, sorting, and view mode controls for model listings
 */
...
/**
 * ItemsFilters component for model filtering and view controls
 * @component
 * @param {Object} props - Component props
 * @param {Object} [props.filters={}] - Current filter state
 * @param {string} [props.sortDir='desc'] - Current sort direction
 * @param {string} [props.view='grid'] - Current view mode
...
export function ItemsFilters({ filters = {}, sortDir = 'desc', view = 'grid' }) {
  ...
  const updateSearchParams = React.useCallback(
    (newFilters, newSortDir) => {
      ...
      router.push(`${paths.dashboard.models}?${searchParams.toString()}`);
    },
    [router, view]
  );
  ...
  const handleViewChange = React.useCallback(
    (value) => {
      if (value) {
        router.push(`${paths.dashboard.models}?view=${value}`);
      }
    },
    [router]
  );
