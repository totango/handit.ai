/**
 * @fileoverview ItemRow component for displaying KPI items in a table row
 * Provides a row view of KPI items with actions and sharing information
 */
...
/**
 * ItemRow component for displaying KPI items in a table row
 * @component
 ...
 * - A table row displaying KPI item information
...
export function ItemRow({ item, onDelete, onFavorite, onOpen, onMenuUpdate }) {
  ...
  // Get shared users and determine if sharing info should be shown
