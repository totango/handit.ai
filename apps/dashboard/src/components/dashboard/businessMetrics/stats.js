/**
 * @fileoverview Stats component for displaying storage usage statistics and file type distribution
 * Provides a visual representation of storage usage and file type breakdown
 */
 ...
 * @type {Array<{extension?: string, itemsCount: number, label: string, size: string}>}
 */
const totals = [
...
/**
 * Stats component for displaying storage usage and file type statistics
 * @component
 * @returns {JSX.Element} Rendered statistics card with storage usage chart and file type breakdown
 * 
 * @description
 * This component displays:
 * - A radial bar chart showing storage usage percentage
 * - Total storage used in GB
 * - Breakdown of file types with their respective sizes and counts
 * - Upgrade plan button for storage expansion
 */
      ...
      <CardContent>
        <Stack spacing={2}>
          <Stack sx={{ alignItems: 'center' }}>
            {/* Radial bar chart for storage usage visualization */}
            <NoSsr fallback={<Box sx={{ height: `${chartSize}px` }} />}>
              ...
              >
                ...
                {/* Storage usage display in the center of the chart */}
                <Box
                  sx={{
                    alignItems: 'center',
                    bottom: 0,
