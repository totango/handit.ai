    ...
    },
    {
      ...
      hooks: {
        ...
        afterCreate: async (model, options) => {
          const ModelMetric = sequelize.models.ModelMetric;
          const modelGroup = await sequelize.models.ModelGroup.findOne({
            where: {
              id: model.modelGroupId,
            },
          });
          const companyId = modelGroup.dataValues.companyId;

          const CompanyAlertsConfiguration =
            sequelize.models.CompanyAlertsConfiguration;
          if (model.problemType === 'binary_class' || model.problemType === 'multi_class' || model.problemType === 'classification') {
            const accuracy = await ModelMetric.create({
              name: 'accuracy',
            ...
            await CompanyAlertsConfiguration.create({
              modelMetricId: accuracy.dataValues.id,
              alertSeverity: 'critical',
              alertType: 'last',
              comparingOperator: 'less_than',
              alertThreshold: 0.7,
              companyId: companyId,
            });

            const precision = await ModelMetric.create({
              name: 'precision',
              description: 'Precision of the model',
              parameters: {
                function: 'true_positive / (true_positive + false_positive)',
              },
              type: 'numeric',
              modelId: model.id,
            });
            ...
            await CompanyAlertsConfiguration.create({
              modelMetricId: precision.dataValues.id,
              alertSeverity: 'critical',
              alertType: 'last',
              comparingOperator: 'less_than',
              alertThreshold: 0.7,
            ...
            const recall = await ModelMetric.create({
              name: 'recall',
              description: 'Recall of the model',
              parameters: {
                function: 'true_positive / (true_positive + false_negative)',
              },
              type: 'numeric',
              modelId: model.id,
            });
            ...
            await CompanyAlertsConfiguration.create({
              modelMetricId: recall.dataValues.id,
              alertSeverity: 'critical',
              alertType: 'last',
              comparingOperator: 'less_than',
              alertThreshold: 0.7,
            ...
            const f1 = await ModelMetric.create({
              name: 'f1',
            ...
            await CompanyAlertsConfiguration.create({
              modelMetricId: f1.dataValues.id,
              alertSeverity: 'critical',
              alertType: 'last',
              comparingOperator: 'less_than',
              alertThreshold: 0.7,
            ...
            await ModelMetric.create({
              name: 'Healtcheck',
              description: 'Healthcheck of the model',
              parameters: {},
              type: 'health_check',
              modelId: model.id,
            });
          } else if (model.problemType === 'text_generation') {
            const avgRelevance = await ModelMetric.create({
              name: 'average_relevance',
              description: 'Average relevance of the model',
              parameters: {},
              type: 'numeric',
              modelId: model.id,
            });
            ...
            await CompanyAlertsConfiguration.create({
              modelMetricId: avgRelevance.dataValues.id,
              alertSeverity: 'critical',
              alertType: 'last',
              comparingOperator: 'less_than',
              alertThreshold: 6,
            ...
            const avgCoherence = await ModelMetric.create({
              name: 'average_coherence',
              description: 'Average coherence of the model',
              parameters: {},
              type: 'numeric',
              modelId: model.id,
            });
            ...
            await CompanyAlertsConfiguration.create({
              modelMetricId: avgCoherence.dataValues.id,
              alertSeverity: 'critical',
              alertType: 'last',
              comparingOperator: 'less_than',
              alertThreshold: 6,
