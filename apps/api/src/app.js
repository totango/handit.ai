...
app.use(cors({
  origin: ['http://127.0.0.1:3000', 'http://localhost:3000', 'http://localhost:3002', '*', 'https://handit-dashboard.vercel.app', 'https://dashboard.handit.ai', 'https://sandbox.handit.ai','https://try.handit.ai', 'https://handit.ai', 'https://www.handit.ai'],
}));
